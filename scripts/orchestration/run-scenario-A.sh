...
echo "======================================================"
echo "[INFO] Starting Systematic Experiment - SCENARIO A ONLY"
echo "Repetitions: $REPETITIONS | Duration per test: $DURATION"
echo "======================================================"

cleanup_environment
setup_experiment_dir "scenario_A"
...
echo "======================================================"
echo "[COMPLETED] Data collection for Scenario A finished."
echo "  - Successful tests: $SUCCESS_COUNT | Failed tests: $FAIL_COUNT"
echo "======================================================"

run_analysis "analyze-scenario-A.py"