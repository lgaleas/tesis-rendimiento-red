...
echo "======================================================"
echo "[INFO] Starting Systematic Experiment - SCENARIO B ONLY"
echo "Repetitions: $REPETITIONS | Duration per test: $DURATION"
echo "======================================================"

cleanup_environment
setup_experiment_dir "scenario_B"
...
echo "======================================================"
echo "[COMPLETED] Data collection for Scenario B finished."
echo "  - Successful tests: $SUCCESS_COUNT | Failed tests: $FAIL_COUNT"
echo "======================================================"

run_analysis "analyze-scenario-B.py"